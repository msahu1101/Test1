...
$OpenApiUrl = $BaseFunctionEndpoint+"/api/control/openapi/apim?code="+$MasterFunctionAccessKey
...
Write-Host "##vso[task.setvariable variable=FUNCTION_APIM_NAME]$ApiSetId"
