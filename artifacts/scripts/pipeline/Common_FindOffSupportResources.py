...
def lastUpdateDateComparator(e):
    in_resources = "https://management.azure.com/subscriptions/32697448-4093-40aa-8487-3ed3da2b4365/resourceGroups/{}/providers/Microsoft.Web/sites/{}/deployments?api-version=2018-02-01".format(in_resourceGroup, e['name'])
...
def getFunctionsFromAzure(in_resourceGroup, in_module, in_env, in_token):
    in_resources = "https://management.azure.com/subscriptions/32697448-4093-40aa-8487-3ed3da2b4365/resourceGroups/{}/providers/Microsoft.Web/sites?api-version=2018-02-01".format(in_resourceGroup)
    headers = { 'Authorization' : 'Bearer ' + in_token}
    rsp = requests.get(in_resources, headers=headers)
    services = json.loads(rsp.text)
    dictList = []
...
for instance in instances:
    ...
    in_resources = "https://management.azure.com/subscriptions/32697448-4093-40aa-8487-3ed3da2b4365/resourceGroups/{}/providers/Microsoft.Web/sites/{}/config/appsettings/list?api-version=2018-02-01".format(in_resourceGroup, instance['name'])
    headers = { 'Authorization' : 'Bearer ' + in_token}
...
for removable in removableFunctions:
    ...
    in_resources = "https://management.azure.com/subscriptions/32697448-4093-40aa-8487-3ed3da2b4365/resourceGroups/{}/providers/Microsoft.Web/sites/{}?api-version=2018-02-01".format(in_resourceGroup, removable)
    headers = { 'Authorization' : 'Bearer ' + in_token}
...
for removable in removableStorageAccounts:
    ...
    in_resources = "https://management.azure.com/subscriptions/32697448-4093-40aa-8487-3ed3da2b4365/resourceGroups/{}/providers/Microsoft.Storage/storageAccounts/{}?api-version=2017-10-01".format(in_resourceGroup, removable)
    headers = { 'Authorization' : 'Bearer ' + in_token}
    rsp = requests.delete(in_resources, headers=headers)
