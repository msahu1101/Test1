...
def getAllDeployment(in_resourceGroup, in_token):
    in_resources = "https://management.azure.com/subscriptions/32697448-4093-40aa-8487-3ed3da2b4365/resourceGroups/{}/providers/Microsoft.Resources/deployments?api-version=2017-05-10".format(in_resourceGroup)
...
for removable in instances:
    ...
    in_resources = "https://management.azure.com/subscriptions/32697448-4093-40aa-8487-3ed3da2b4365/resourceGroups/{}/providers/Microsoft.Resources/deployments/{}?api-version=2017-05-10".format(in_resourceGroup, removable)
    headers = { 'Authorization' : 'Bearer ' + in_token}
