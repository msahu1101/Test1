...
public class CommentTransformerTest {
    ...
    @Test
    public void toLeft() throws AppException, ParseException {
        List<CustomerComment> customerComments = new ArrayList<CustomerComment>();
        CustomerComment customerComment = new CustomerComment();
        customerComment.setCreateDate(ZonedDateTime.parse("2020-01-03T11:15:00.000-08:00", FORMAT));
        customerComment.setExpiryDate(ZonedDateTime.parse("2020-01-03T11:15:00.000-08:00", FORMAT));
        ...
        Assertions.assertThrows(UnsupportedOperationException.class, () -> mockPatronCustomerCommentTransformer.toLeft(customerComments));
    }
    ...
    public void testToRight() throws Exception {
        ...
        List<CustomerComment> customerComments = mockPatronCustomerCommentTransformer.toRight(playerComments);
        Assertions.assertNotNull(customerComments);
    ...
    @Test
    public void testToRightForWrongXML() throws Exception {
        List<PlayerComment> playerComments = new ArrayList<PlayerComment>();
        PlayerComment playerComment = new PlayerComment();
        String result = "<CRMAcresMessage xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\">\r\n" + "  <Header>\r\n"
                + "    <TimeStamp>2018-04-10T10:01:04.713</TimeStamp>\r\n" + "    <Operation Data=\"Comments\" Operand=\"Information\" />\r\n" + "  </Header>\r\n"
        ...
        playerComment.setResult(result);
        playerComments.add(playerComment);
        Assertions.assertThrows(AppRuntimeException.class, () -> mockPatronCustomerCommentTransformer.toRight(playerComments));
    }

    @Test
    public void testToRightForNullResult() throws Exception {
        List<PlayerComment> playerComments = new ArrayList<PlayerComment>();
        PlayerComment playerComment = new PlayerComment();
        playerComment.setResult(null);
        playerComments.add(playerComment);
        Assertions.assertThrows(AppRuntimeException.class, () -> mockPatronCustomerCommentTransformer.toRight(playerComments));
    }
}
